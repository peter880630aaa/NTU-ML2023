...
def parse_args():
    ...
    parser.add_argument(
        "--pred_file", type=str, default=None, help="A csv or a json file to save the predictions."
    )
    parser.add_argument(
        "--max_seq_length",
        type=int,
...
def main():
    ...
    def org2squad(example):
        ...
        squad["context"] = test_paragraphs[example["paragraph_id"]]
        answers = {}
    ...
    raw_datasets = raw_datasets.map(
        org2squad, remove_columns=column_names
    )
